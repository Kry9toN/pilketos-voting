        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Form Import Siswa</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			 <!--Mulai buat form-->
			 <form action="?m=siswa&s=simpan" method="post" enctype="multipart/form-data">
              <table id="pilkasis1" class="table table-bordered table-hover table-striped">
                <tbody>
					<tr>
						<td width=174>Upload File excel*</td>
						<td><input type="file" name="file" size="10px" maxlength="9px" required /></td>
					</tr>
					<tr>
						<td colspan=3>
						<input type="submit" name="import" value="Save" class="btn btn-large btn-primary" />&nbsp;&nbsp;&nbsp;
