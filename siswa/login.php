...
<head>
  <meta charset="UTF-8">
  <title>Login Siswa Pilketos | SMKN 1 UDANAWU</title>
  ...
  <div class="col-sm-10 main-section">
    ...
    <form method="post" action="logincek.php">
      <div class="form-group usr">
        <input class="form-control" id="usr" aria-describedby="emailHelp" placeholder="Username" name="nama" type="text" required="required">
      </div>
...
<script src="/assets/js/countdownsiswa.js"></script>
